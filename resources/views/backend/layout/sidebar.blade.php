...
<aside class="app-sidebar">
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-bs-toggle="slide" href="#"><i
                    class="side-menu__icon fe fe-globe"></i><span class="side-menu__label">Blog</span><i
                    class="angle fa fa-angle-left"></i></a>
            <ul class="slide-menu">
                <li><a href="{{route('create_blog')}}" class="slide-item">create Blog</a></li>
                <li><a href="{{route('blog')}}" class="slide-item">Blog List</a></li>
            </ul>
        </li>
        <li>
            <h3>Elements</h3>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a href="listpage.html" class="slide-item"> List</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-bs-toggle="slide" href="#"><i
                    class="side-menu__icon fe fe-file"></i><span class="side-menu__label">Advanced Elements</span><i
                    class="angle fa fa-angle-left"></i></a>
            <ul class="slide-menu">
            ...
            <ul class="slide-menu">
                ...
                <li class="sub-slide">
                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                            class="sub-side-menu__label">Level-2</span><i class="sub-angle fa fa-angle-left"></i></a>
                    <ul class="sub-slide-menu">
                        ...
                        <li class="sub-slide2">
                            <a class="sub-side-menu__item2" href="#" data-bs-toggle="sub-slide2"><span
                                    ...
                                    class="sub-angle2 fa fa-angle-left"></i></a>
