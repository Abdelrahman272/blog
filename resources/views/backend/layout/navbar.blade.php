            ...
            <div class="d-flex order-lg-2 ms-auto header-right-icons">
                        ...
                        <div class="message-menu">
                            <a class="dropdown-item d-flex" href="chat.html">
                                <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                    data-bs-image-src="{{ asset('backend/assets/images/users/1.jpg') }}"></span>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a class="dropdown-item d-flex" href="chat.html">
                                <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                    data-bs-image-src="{{ asset('backend/assets/images/users/12.jpg') }}"></span>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a class="dropdown-item d-flex" href="chat.html">
                                <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                    data-bs-image-src="{{ asset('backend/assets/images/users/4.jpg') }}"></span>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a class="dropdown-item d-flex" href="chat.html">
                                <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                    data-bs-image-src="{{ asset('backend/assets/images/users/15.jpg') }}"></span>
                                <div class="wd-90p">
                                    <div class="d-flex">
                ...
                <div class="dropdown d-none d-md-flex profile-1">
                    <a href="#" data-bs-toggle="dropdown" class="nav-link ps-2 leading-none d-flex">
                        <span>
                            <img src="{{ asset('backend/assets/images/users/8.jpg') }}" alt="profile-user"
                ...
                <div class="dropdown d-none d-md-flex header-settings">
                    <a href="#" class="nav-link icon " data-bs-toggle="sidebar-left"
